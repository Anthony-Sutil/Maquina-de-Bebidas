...
def calcular_troco(valor_troco):
    ...
    troco = round(valor_troco, 2)*100 # Converte o troco de centavos para reais
    notas_moedas_dadas = {} # Dicionário para armazenar as notas e moedas dadas
    ...
    for nota_moeda, estoque in estoque_notas_moedas.items(): # Percorre o estoque de notas e moedas
        ...
        if quantidade_notas_moedas > 0: # Verifica se a quantidade de notas/moedas pode ser dada
            ...
            notas_moedas_dadas[nota_moeda] = quantidade_notas_moedas # Adiciona a quantidade de notas/moedas dadas ao dicionário
    ...
    if troco == 0: # Verifica se o troco foi dada com sucesso
        ...
        for nota_moeda, quantidade in notas_moedas_dadas.items(): # Percorre o dicionário de notas e moedas dadas
            print(f"{int(quantidade)} notas/moedas de R${(nota_moeda/100):.2f}") # Apresenta a quantidade de notas/moedas dadas em reais e centavos
